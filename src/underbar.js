(function() {
  ...
  _.filter = function(collection, test) {
    ...
    _.each(collection, function(element){
      if (test(element)){
        elementsTruthy.push(element);
      }
    });
    return elementsTruthy;
  };
  ...
  _.map = function(collection, iterator) {
    ...
    if (Array.isArray(collection)){
      ...
      mapped = {};
      _.each(collection, function(element){
        mapped[element] = (iterator(element));
      });
    }
    return mapped
  };
  ...
  _.memoize = function(func) {
    ...
    return function(){
      ...
      //console.log(memokey);
      if(!memoObj.hasOwnProperty(memokey)){
        memoObj[memokey] = func.apply(this, arguments);
      }
      return memoObj[memokey];
  ...
  _.delay = function(func, wait) {
    var funcArguments = Array.from(arguments).slice(2, arguments.length);
  ...
  _.shuffle = function(array) {
    ...
    while(arrCopy.length !== 0){
      var arrElement = getRandomInt(0, arrCopy.length);
      output.push(arrCopy[arrElement]);
      arrCopy.splice(arrElement, 1);
    }
    return output;
  };
